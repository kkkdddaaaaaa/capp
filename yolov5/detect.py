...
@torch.no_grad()
def run(
        weights=ROOT / 'runs/train/result_bong2/weights/best.pt',  # model.pt path(s)
        source=ROOT / 'testimg/1.jpg',  # file/dir/URL/glob, 0 for webcam
        data=ROOT / 'dataset23/data.yaml',  # dataset.yaml path
...
def parse_opt():
    ...
    parser.add_argument('--source', type=str, default='/testimg/1.jpg', help='file/dir/URL/glob, 0 for webcam')
    parser.add_argument('--data', type=str, default=ROOT / '/dataset23/data.yaml', help='(optional) dataset.yaml path')
